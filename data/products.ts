import { Product, Category, CustomerReview, LookbookHotspot } from "@/types/shop";
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    tags: ["Nitrogen Foam", "Carbon Plate", "Ultralight 195g", "Breathable Mesh"],
    description:
...
export const REVIEWS: CustomerReview[] = [
  {
    ...
    rating: 5,
    date: "2 days ago",
    title: "Best ANC headphones I have ever worn",
    comment:
      "The spatial soundstage on the Aura Studio Pro is phenomenal. I use them daily on flights and in crowded cafes. Battery life easily exceeded the 40-hour claim. Customer service was super quick too!",
    verified: true,
  ...
  },
  {
    ...
    rating: 5,
    date: "1 week ago",
    title: "The Titanium Ultra watch is absolute perfection",
    comment:
      "The titanium finish looks like a $1,500 luxury timepiece. Screen is bright even under blinding desert sunlight. Heart rate and sleep tracking matches my hospital pulse oximeter.",
    verified: true,
  ...
  },
  {
    ...
    rating: 5,
    date: "2 weeks ago",
    title: "The leather craftsmanship is sublime",
    comment:
      "I was hesitant about ordering leather goods online without touching them first, but this weekender bag exceeded my expectations. Thick, rich leather that smells amazing. Fits perfectly into overhead aircraft bins.",
    verified: true,
    productName: "Heritage Full-Grain Leather Weekender Bag",
    productImage: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=200&auto=format&fit=crop&q=80",
    helpfulCount: 38,
  },
  {
    id: "rev-4",
    ...
    rating: 5,
    date: "3 weeks ago",
    title: "Nordic desk lamp turned my home office into a sanctuary",
    comment:
      "The concrete aggregate texture with the warm amber glow creates such a peaceful evening vibe. Shipping to Denmark took only 3 days. Beautifully packaged!",
    verified: true,
