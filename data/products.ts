...
<<<<<<< HEAD
  ...
  {
    id: "prod-8",
    name: "Artisan Pour-Over Ceramic Coffee Brew Set",
    slug: "artisan-pour-over-ceramic-coffee-set",
    brand: "Kurasu Studio",
    category: "Home & Ambient",
    price: 7999.00,
    ...
    colors: [
      ...
      { name: "Off White Sand", hex: "#f8fafc" },
      { name: "Terracotta Clay", hex: "#c2410c" },
    ],
    tags: ["Handcrafted Mino Ware", "Heat Retentive", "Includes 600ml Server", "Barista Tested"],
    description:
      "Handcrafted by 4th-generation potters in Mino, Japan. Features precision internal spiral flow ribs engineered to extract optimal sweetness and body from single-origin roasts.",
    features: [
      "High thermal retention ceramic composition",
      "Includes heat-resistant borosilicate glass carafe (600ml)",
      "Universal fit for standard cone filters",
      "Dishwasher and microwave safe",
    ],
    specs: {
      Capacity: "1-4 Cups (600ml Max Server)",
      Material: "Japanese Mino Stoneware & Heat-Proof Glass",
      Country: "Crafted in Gifu Prefecture, Japan",
    },
  },
  {
=======
